            ...
            <svg width="32px" height="32px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#000000" data-darkreader-inline-fill="" style={{padding: "5px", marginLeft: "15px"}}>
                <g>
                    <g fill="#ffffff" fillRule="evenodd" data-darkreader-inline-fill="" >
                        ...
                        <path d="M20 7v14a3.009 3.009 0 0 1-3 3H5a1 1 0 0 1 0-2h12a1.016 1.016 0 0 0 1-1V7a1 1 0 0 1 2 0z"></path> <circle cx="8" cy="15" r="1"></circle>
                        <path d="M12 8a3.992 3.992 0 0 1-3 3.87V12a1 1 0 0 1-2 0v-1a1 1 0 0 1 1-1 2 2 0 1 0-2-2 1 1 0 1 1-2 0 4 4 0 1 1 8 0z"></path> </g> </g></svg>
        </div>
